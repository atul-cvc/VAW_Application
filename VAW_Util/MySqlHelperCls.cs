...
namespace VAW_Util
{
    ...
    /// </summary>
    public sealed class MySqlHelperCls
    {
        #region private utility methods & constructors

        // Since this class provides only static methods, make the default constructor private to prevent 
        // instances from being created with "new SqlHelper()"
        private MySqlHelperCls() { }
        ...
        public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(MySqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(MySqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(MySqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(MySqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static MySqlDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static MySqlDataReader ExecuteReaderTypedParams(MySqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static MySqlDataReader ExecuteReaderTypedParams(MySqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(MySqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(MySqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(MySqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(MySqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return MySqlHelperCls.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return MySqlHelperCls.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
