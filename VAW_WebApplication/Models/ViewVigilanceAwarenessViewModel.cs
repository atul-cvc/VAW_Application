...
namespace VAW_WebApplication.Models
{
    ...
    {
        public List<Tran_a_1b_capacitybulidingprogram_ViewModel> CapacityBuiliding {  get; set; }
        ...
        {
            CapacityBuiliding = new List<Tran_a_1b_capacitybulidingprogram_ViewModel>();
